...
export const config = {
  matcher: [
    ...
    "/((?!_next/static|_next/image|favicon.ico|icon.svg|manifest.webmanifest|sw.js|robots.txt|sitemap.xml|llms.txt|lp.html|assets/|img/|fonts/|.*\\.(?:svg|png|jpg|jpeg|gif|webp|js|css|woff2?|ico|txt|map)$).*)",
  ],
};
