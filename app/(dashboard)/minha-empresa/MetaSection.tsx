      ...
      <div className="flex flex-col gap-4">
        <div className="flex flex-col items-center">
          ...
          <input
            ...
            className="w-full max-w-[240px] rounded-button border border-neutro-border bg-escuro/[0.04] px-4 py-3 text-center text-2xl font-semibold text-primary-forte outline-none focus:border-primary-forte"
          />
          {metaMensal > 0 && (
