                  ...
                  {dh.aberto ? (
                    <div className="flex flex-1 items-center gap-2">
                      <input
                        ...
                        className="w-full rounded-button border border-neutro-border bg-escuro/[0.04] px-2 py-1.5 text-base text-escuro outline-none focus:border-primary-forte md:text-xs"
                      />
