    ...
    <div>
      ...
      <div className="flex flex-wrap gap-2">
        {categorias.map((categoria) => (
          <span
            key={categoria.id}
            className="flex items-center gap-1.5 rounded-full border border-neutro-border bg-escuro/[0.04] py-1.5 pl-3.5 pr-2 text-xs font-semibold text-escuro"
          >
            {categoria.nome}
            <button
              type="button"
      ...
      <div className="mt-3 flex gap-2">
        <input
          ...
          className="flex-1 rounded-button border border-neutro-border bg-escuro/[0.04] px-3.5 py-2 text-base text-escuro outline-none focus:border-primary-forte md:text-sm"
        />
        <button
          type="button"
          onClick={adicionar}
