    ...
    >
      ...
      >
        ...
        <input
          ...
          className="mt-4 w-full rounded-button border border-neutro-border bg-fundo px-4 py-3 text-center text-2xl font-semibold text-coral outline-none focus:border-coral"
        />
