...
const STATS = [
  { valor: "47", label: "visitas" },
  { valor: "R$ 4.820", label: "gasto total" },
  { valor: "12 dias", label: "frequência" },
] as const;
            ...
            <div className="rounded-2xl bg-superficie p-5 shadow-[0_4px_24px_rgba(0,0,0,0.08)]">
              <div className="flex items-center gap-3 border-b border-neutro-border pb-4">
                ...
                <div>
                  ...
                  <span className="mt-1 inline-flex items-center gap-1 rounded-full bg-ambar-soft px-2 py-0.5 text-[10px] font-bold text-ambar-text">
              ...
              <div className="mt-4 grid grid-cols-3 gap-2 text-center">
                {STATS.map((stat) => (
                  <div key={stat.label} className="rounded-xl bg-fundo px-2 py-3">
                    <p className="text-base font-extrabold text-escuro">{stat.valor}</p>
