...
const variantClasses: Record<ButtonVariant, string> = {
  ...
  /*
   * O secundário é VIDRO, e não uma superfície opaca com contorno néon.
   *
   * Era `bg-superficie` com borda de 1,5px em néon: sobre o papel de parede,
   * uma placa chapada contornada de verde — e como ele aparece aos pares
   * ("Não compareceu" / "Remarcar", "Sim" / "Agora não"), a tela ganhava duas
   * molduras acesas disputando atenção com o botão principal, que é o único
   * que deveria estar aceso.
   *
   * `vidro-card` resolve os dois temas sozinho, que é por isso que não dá para
   * trocar por um branco com transparência: no tema claro ele sumiria.
   */
  secondary:
    "vidro-card text-escuro disabled:text-neutro-disabled-text",
